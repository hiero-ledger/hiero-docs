...
[Hiero-Local-Node] INFO (StateController) [✔︎] Starting restart procedure!
[Hiero-Local-Node] INFO (CleanUpState) ⏳ Initiating clean up procedure. Trying to revert unneeded changes to files...
[Hiero-Local-Node] INFO (CleanUpState) [✔︎] Clean up of consensus node properties finished.
[Hiero-Local-Node] INFO (CleanUpState) [✔︎] Clean up of mirror node properties finished.
[Hiero-Local-Node] INFO (StopState) ⏳ Initiating stop procedure. Trying to stop docker containers and clean up volumes...
[Hiero-Local-Node] INFO (StopState) ⏳ Stopping the network...
[Hiero-Local-Node] INFO (StopState) [✔︎] Hiero Local Node was stopped successfully.
[Hiero-Local-Node] INFO (InitState) ⏳ Making sure that Docker is started and it is correct version...
[Hiero-Local-Node] INFO (DockerService) ⏳ Checking docker compose version...
[Hiero-Local-Node] INFO (DockerService) ⏳ Checking docker resources...
[Hiero-Local-Node] WARNING (DockerService) [!] Port 3000 is in use.
[Hiero-Local-Node] INFO (InitState) ⏳ Setting configuration with latest images on host 127.0.0.1 with dev mode turned off using turbo mode in single node configuration...
[Hiero-Local-Node] INFO (InitState) [✔︎] Local Node Working directory set to /Users/owanate/Library/Application Support/hedera-local.
[Hiero-Local-Node] INFO (InitState) [✔︎] Hedera JSON-RPC Relay rate limits were disabled.
[Hiero-Local-Node] INFO (InitState) [✔︎] Needed environment variables were set for this configuration.
[Hiero-Local-Node] INFO (InitState) [✔︎] Needed bootsrap properties were set for this configuration.
[Hiero-Local-Node] INFO (InitState) [✔︎] Needed bootsrap properties were set for this configuration.
[Hiero-Local-Node] INFO (InitState) [✔︎] Needed mirror node properties were set for this configuration.
[Hiero-Local-Node] INFO (StartState) ⏳ Starting Hiero Local Node...
```
{% endcode %}
...
> @hashgraph/hedera-local@2.26.2 build
> rimraf ./build && tsc
[Hiero-Local-Node] INFO (StartState) [✔︎] Hiero Local Node successfully started!
[Hiero-Local-Node] INFO (NetworkPrepState) ⏳ Starting Network Preparation State...
[Hiero-Local-Node] INFO (NetworkPrepState) [✔︎] Imported fees successfully!
[Hiero-Local-Node] INFO (NetworkPrepState) [✔︎] Topic was created!
[Hiero-Local-Node] INFO (AccountCreationState) ⏳ Starting Account Creation state in synchronous mode ...
[Hiero-Local-Node] INFO (AccountCreationState) |-----------------------------------------------------------------------------------------|
[Hiero-Local-Node] INFO (AccountCreationState) |-----------------------------| Accounts list (ECDSA keys) |----------------------------|
[Hiero-Local-Node] INFO (AccountCreationState) |-----------------------------------------------------------------------------------------|
[Hiero-Local-Node] INFO (AccountCreationState) |    id    |                            private key                            |  balance |
[Hiero-Local-Node] INFO (AccountCreationState) |-----------------------------------------------------------------------------------------|
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1002 - 0x7f109a9e3b0d8ecfba9cc23a3614433ce0fa7ddcc80f2a8f10b222179a5a80d6 - 10000 ℏ |
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1003 - 0x6ec1f2e7d126a74a1d2ff9e1c5d90b92378c725e506651ff8bb8616a5c724628 - 10000 ℏ |
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1004 - 0xb4d7f7e82f61d81c95985771b8abf518f9328d019c36849d4214b5f995d13814 - 10000 ℏ |
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1005 - 0x941536648ac10d5734973e94df413c17809d6cc5e24cd11e947e685acfbd12ae - 10000 ℏ |
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1006 - 0x5829cf333ef66b6bdd34950f096cb24e06ef041c5f63e577b4f3362309125863 - 10000 ℏ |
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1007 - 0x8fc4bffe2b40b2b7db7fd937736c4575a0925511d7a0a2dfc3274e8c17b41d20 - 10000 ℏ |
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1008 - 0xb6c10e2baaeba1fa4a8b73644db4f28f4bf0912cceb6e8959f73bb423c33bd84 - 10000 ℏ |
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1009 - 0xfe8875acb38f684b2025d5472445b8e4745705a9e7adc9b0485a05df790df700 - 10000 ℏ |
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1010 - 0xbdc6e0a69f2921a78e9af930111334a41d3fab44653c8de0775572c526feea2d - 10000 ℏ |
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1011 - 0x3e215c3d2a59626a669ed04ec1700f36c05c9b216e592f58bbfd3d8aa6ea25f9 - 10000 ℏ |
[Hiero-Local-Node] INFO (AccountCreationState) |-----------------------------------------------------------------------------------------|
[Hiero-Local-Node] INFO (AccountCreationState) |--------------------------------------------------------------------------------------------------------------------------------------|
[Hiero-Local-Node] INFO (AccountCreationState) |------------------------------------------------| Accounts list (Alias ECDSA keys) |--------------------------------------------------|
[Hiero-Local-Node] INFO (AccountCreationState) |--------------------------------------------------------------------------------------------------------------------------------------|
[Hiero-Local-Node] INFO (AccountCreationState) |    id    |               public address               |                             private key                            | balance |
[Hiero-Local-Node] INFO (AccountCreationState) |--------------------------------------------------------------------------------------------------------------------------------------|
[Hiero-Local-Node] INFO (AccountCreationState) | 0.0.1012 - 0x67d8d32e9bf1a9968a5ff53b87d777aa8ebbee69 - 0x105d050185ccb907fba04dd92d8de9e32c18305e097ab41dadda21489a211524 - 10000 ℏ |
.....
[Hiero-Local-Node] INFO (AccountCreationState) |-----------------------------------------------------------------------------------------|
[Hiero-Local-Node] INFO (AccountCreationState) [✔︎] Accounts created succefully!
[Hiero-Local-Node] INFO (CleanUpState) ⏳ Initiating clean up procedure. Trying to revert unneeded changes to files...
[Hiero-Local-Node] INFO (CleanUpState) [✔︎] Clean up of consensus node properties finished.
[Hiero-Local-Node] INFO (CleanUpState) [✔︎] Clean up of mirror node properties finished.
```
...
![Running Hedera Node on Terminal](broken-reference)
...
![Hedera Explorer - View LOCALNET](broken-reference)

![Hedera Explorer - View LOCALNET Details](broken-reference)
...
[Hiero-Local-Node] INFO (StateController) [✔︎] Starting start procedure!
[Hiero-Local-Node] INFO (InitState) ⏳ Making sure that Docker is started and it is correct version...
[Hiero-Local-Node] INFO (DockerService) ⏳ Checking docker compose version...
[Hiero-Local-Node] INFO (DockerService) ⏳ Checking docker resources...
[Hiero-Local-Node] ERROR (DockerService) [✘] [✘] Port 5551 is in use.
[Hiero-Local-Node] ERROR (DockerService) [✘] [✘] Port 8545 is in use.
[Hiero-Local-Node] ERROR (DockerService) [✘] [✘] Port 5600 is in use.
[Hiero-Local-Node] ERROR (DockerService) [✘] [✘] Port 5433 is in use.
[Hiero-Local-Node] ERROR (DockerService) [✘] [✘] Port 8082 is in use.
[Hiero-Local-Node] ERROR (DockerService) [✘] [✘] Port 6379 is in use.
[Hiero-Local-Node] WARNING (DockerService) [!] Port 7546 is in use.
[Hiero-Local-Node] WARNING (DockerService) [!] Port 8080 is in use.
[Hiero-Local-Node] WARNING (DockerService) [!] Port 3000 is in use.
[Hiero-Local-Node] ERROR (DockerService) [✘] [✘] Node cannot start properly because necessary ports are in use!
```
{% endcode %}
