...
Staking is the process of participating in a [proof-of-stake](broken-reference) system to validate transactions and earn rewards. When staked, coins are locked but can be unlocked for trading. Staking allows participants (stakeholders) to earn rewards on their holdings, typically in tokens or coins.&#x20;
